...
function predefinedClick(param) {
    if (param == PREDEFINEDS.GET_CURR) {
        ...
        const mixedMaxGraph = '{"canvasWidth":428,"canvasHeight":538,"vertices":[{"x":100,"y":300,"nr":0},{"x":200,"y":300,"nr":1},{"x":300,"y":300,"nr":2},{"x":200,"y":200,"nr":3},{"x":200,"y":100,"nr":4}],"edges":[{"v1nr":4,"v2nr":3,"weight":16},{"v1nr":3,"v2nr":0,"weight":0},{"v1nr":0,"v2nr":1,"weight":11},{"v1nr":1,"v2nr":2,"weight":1},{"v1nr":2,"v2nr":3, "weight":5},{"v1nr":3,"v2nr":1,"weight":-6}]}';        loadGraphFromJson(mixedMaxGraph);
